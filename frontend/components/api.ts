...
export type PriceResult = { id: string; project_id: string; candidate_id: string; service_name: string; item_name?: string; specification?: string; unit?: string; lookup_status: string; price?: number; source_file_id?: string; reference_date?: string; created_at?: string; source_set?: string; work_package?: string; baseline_quantity?: string; changed_quantity?: string; difference?: string; evidence?: string; reference_match_count?: number; best_reference_price?: number; best_reference_scope?: string; reference_match_status?: string };
...
export const drawingPdfPreviewUrl = (projectId: string, candidateId: string, side: "baseline" | "changed", page: number, bundle: "main" | "masonry-plan" = "main") =>
